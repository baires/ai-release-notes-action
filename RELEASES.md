...
- **Usage in workflows**:
  - `baires/ai-release-notes-action@v1.0.11` (specific version)
...
sed -i 's|baires/ai-release-notes-action@v1[0-9]*\.[0-9]*\.[0-9]*|baires/ai-release-notes-action@v1.0.11|g' README.md
